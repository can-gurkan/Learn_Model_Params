...
def run_model(params, reps):
    ...
    for i in [0, 1, 3, 5]:
        params[i] *= 100
    update_xml('exp_template.xml', params, reps)
    #subprocess.call(['rm', 'test.csv'])
    subprocess.call(
        ['/Applications/NetLogo 6.1.0/netlogo-headless.sh', '--model', 'Virus-Parameter-Learning.nlogo', '--setup-file',
         'exp_template.xml', '--experiment', 'Test', '--table',
         '/Users/old/Documents/NUCS/Y3Q2/DL/Learning-to-Simulate/test.csv'])
